"""
MCP Server for Text Analyzer Agent
This server connects to GigaChat API and provides text analysis capabilities
"""
...
# Create MCP server
server = Server("text-analyzer-agent")


@server.call_tool()
async def analyze_text(arguments: dict) -> dict:
    """Analyze text using GigaChat"""
