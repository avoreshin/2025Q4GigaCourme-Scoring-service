"""
MCP Server for Financial Analyzer Agent
"""
...
server = Server("financial-analyzer-agent")


@server.call_tool()
async def analyze_financials(arguments: dict) -> dict:
    """Analyze financial information using GigaChat"""
